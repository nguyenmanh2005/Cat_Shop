          ...
          {!needsVerification ? (
            <>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-lg border border-dashed border-blue-300 bg-blue-50/40 px-4 py-2 text-sm font-medium text-blue-700 transition hover:bg-blue-100"
              >
