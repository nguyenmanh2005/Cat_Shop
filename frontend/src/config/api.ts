...
export const API_CONFIG = {
  ...
  TIMEOUT: parseInt(import.meta.env.VITE_API_TIMEOUT || '30000'), // Tăng timeout lên 30s cho login
  ...
  ENDPOINTS: {
    ...
    AUTH: {
      ...
      // OTP Login - Backend tự động gửi OTP khi login với thiết bị mới, không cần endpoint riêng
