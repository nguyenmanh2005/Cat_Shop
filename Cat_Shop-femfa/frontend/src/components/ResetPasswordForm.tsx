...
const ResetPasswordForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.message || err.message || "Không thể đặt lại mật khẩu. Vui lòng thử lại.";
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Link đặt lại mật khẩu không hợp lệ hoặc đã hết hạn. Vui lòng kiểm tra lại email hoặc yêu cầu link mới.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardTitle className="text-center text-green-700">Đặt lại mật khẩu thành công!</CardTitle>
            <CardDescription className="text-center">
              Mật khẩu của bạn đã được đặt lại thành công. Tất cả các thiết bị đã được đăng xuất để bảo mật.
            </CardDescription>
          </CardHeader>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Alert>
              ...
              <AlertDescription>
                Sau khi đặt lại mật khẩu, tất cả các thiết bị sẽ được đăng xuất tự động để bảo mật. 
