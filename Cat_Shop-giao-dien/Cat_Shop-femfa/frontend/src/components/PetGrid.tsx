...
const PetGrid = () => {
  ...
  const handleAddToCart = (product: Product) => {
    ...
    toast({
      title: "Added to Cart",
      description: `${product.productName} has been added to cart.`,
    });
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6 animate-fade-in-down">
          ...
          <div className="flex gap-4">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent>
                <SelectItem key="sort-default" value="default">Default</SelectItem>
                ...
                <SelectItem key="sort-name-az" value="name-a-z">Name: A to Z</SelectItem>
                <SelectItem key="sort-name-za" value="name-z-a">Name: Z to A</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        {filteredProducts.length > 0 ? (
          ...
          <div className="text-center py-12 animate-fade-in">
            ...
            {loading && <p className="text-sm text-muted-foreground mt-2 animate-pulse">Loading...</p>}
          </div>
        )}
      </div>
    </div>
