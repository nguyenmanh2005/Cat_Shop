...
const OtpForm = () => {
  ...
  // OTP và Google Authenticator là 2 phương thức xác thực độc lập
  ...
  return (
    <div className="mx-auto max-w-md rounded-xl bg-white p-6 shadow-sm">
      <h2 className="mb-4 text-2xl font-semibold text-slate-900">Device Verification</h2>
      <p className="mb-6 text-sm text-slate-500">
        Please enter the OTP code sent to email <span className="font-medium">{email}</span>.
      </p>
