  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-x-hidden page-transition">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-8 animate-fade-in-down">Your Cart</h1>
                      ...
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            toast({
                              title: "Removed",
                              description: `${item.product.productName} has been removed from cart`,
                            });
                          }}
