  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "You can return to the browser on your computer",
      });
      ...
      if (errorMessage.includes("token") || errorMessage.includes("Token") || 
          error.response?.status === 401) {
        errorMessage = "Login information is incorrect. Please check your email and password.";
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {status === "scanning" && "Scan QR code from computer to login"}
            {status === "login" && "Enter your login information"}
        ...
        <CardContent className="space-y-4">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button type="submit" className="flex-1" disabled={isSubmitting}>
                  {isSubmitting ? "Processing..." : "Confirm Login"}
                </Button>
          ...
          {status === "success" && (
            <div className="text-center space-y-4">
              ...
              <p className="text-lg font-semibold text-blue-600">Login Successful!</p>
              <p className="text-sm text-muted-foreground">
                You can return to the browser on your computer
              </p>
            </div>
          )}
